...
#plot the four figures into plot4.png
png(filename = "plot4.png",
    width = 480, height = 480, units = "px")

par( mfrow = c(2, 2))
plot( datetime, m[,1],  type="l",lty = 1, col = "black", xlab="",ylab="Global Active Power")

plot( datetime, m[,3],  type="l",lty = 1, col = "black", xlab="datetime",ylab="Voltage")
...
legend("topright", lty = 1, col = c("black","red","blue" ), bty ="n", inset = c(0, 0), legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"))

plot( datetime, m[,2],  type="l",lty = 1, col = "black", xlab="datetime",ylab="Global_reactive_power")
